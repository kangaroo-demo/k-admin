  ...
  <div class="trend-data-container">
    ...
    <div class="item">
      ...
      <div class="item-amount">
        <span class="item-amount-number" ref="tadayAddedTarget"></span>
        {{ $t('msg.chart.unit') }}
      </div>
    </div>
    <!-- 今日支出 -->
    <div class="item">
      ...
      <div class="item-amount">
        <span class="item-amount-number" ref="tadayExpendTarget"></span>
        {{ $t('msg.chart.unit') }}
      </div>
    </div>
    <!-- 今日结余 -->
    <div class="item">
      ...
      <div class="item-amount">
        <span class="item-amount-number" ref="tadayBalanceTarget"></span>
        {{ $t('msg.chart.unit') }}
      </div>
    </div>
  </div>
